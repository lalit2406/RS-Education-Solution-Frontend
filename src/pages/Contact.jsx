...
export default function Contact() {
  ...
  return (
    <>
      <SEO
        title="Contact RS Education"
        description="Contact RS Education for admission guidance, counseling, scholarships and career support."
        keywords="contact education consultant, career guidance"
        url="https://rseducationsolution.in/contact"
        image="https://rseducationsolution.in/preview.png"
      />
      <div className="rs-contact-page">
        ...
        <section className="rs-contact-hero">
          ...
          <div className="rs-contact-bg">
            <img
              src="/images/home/contact_bg.webp"
              alt="background"
              loading="eager"
            />
          </div>
            ...
            {rsContactLoading ? (
              ...
              <>
                ...
                <p>
                  ...
                  within 24 hours. Whether you need help choosing a program,
                  preparing for exams, or applying to universities — we’re here
                  for you.
                </p>
